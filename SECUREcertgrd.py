...
def entropy(string):
    """Calculates the Shannon entropy (uncertainty) of a string"""
...
def score_domain(domain):
    ...
    The highest score, the most probable `domain` is the most insecure site.
